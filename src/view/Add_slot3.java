...
//_________________For a specific day __________________

public class Add_slot3  extends Stage {
   ...
   public Add_slot3 (AppData appData , LocalDate day ) {
     		         ...
     		         this.setScene(this.getScene());
                	    ...
                	    if (minutes<model.getPlanner().getMinTimeSlotMinute())
                	    {
                	    	 ...
                	    	 TimeSlot timeSlot= new TimeSlot(HeureDebut,HeureFin );
                       		 model.getPlanner().getCalendar().add_TimeSlot(day, timeSlot);
