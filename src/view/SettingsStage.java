...
public class SettingsStage extends Stage {
    ...
    public SettingsStage(AppData appData) {
        ...
        Button  addTimeslotButton = new Button("Add  new timeslot");
        ...
        addCategoryButton.setOnAction(event -> {
        	...
        	Add_Category newCat = new Add_Category(appData);
        	newCat.show();

        });
        addTimeslotButton.setOnAction(event -> {

        	Ajout_Creneau newCat = new Ajout_Creneau(appData.getCurrentUser());
        	newCat.show();
     ...
     // Handle "Change minimal number of tasks" button click
        ...
        root.getChildren().addAll(titleLabel, changeMinTasksButton, addCategoryButton,addTimeslotButton,
